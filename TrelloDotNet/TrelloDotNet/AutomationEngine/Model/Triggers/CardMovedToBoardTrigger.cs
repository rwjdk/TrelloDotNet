...
{
    /// <summary>
    /// Trigger that happens when a card is moved to the board
    /// </summary>
    public class CardMovedToBoardTrigger : IAutomationTrigger
    {
        /// <summary>
        ...
        public async Task<bool> IsTriggerMetAsync(WebhookAction webhookAction)
        {
            ...
            return webhookAction.Type == WebhookActionTypes.MoveCardToBoard;
        }
    }
}