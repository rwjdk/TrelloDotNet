...
#pragma warning restore CS0414
    ...
    private void SubscribeToEventsProcessAndWait(WebhookDataReceiver receiver, string json)
    {
        ...
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AcceptEnterpriseJoinRequest));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddAttachmentToCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddChecklistToCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddMemberToBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddMemberToCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddMemberToOrganization));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddOrganizationToEnterprise));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddToEnterprisePluginWhitelist));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddToOrganizationBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CommentCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.ConvertToCardFromCheckItem));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CopyBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CopyCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CopyCommentCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateList));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateOrganization));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteBoardInvitation));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteOrganizationInvitation));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DisableEnterprisePluginWhitelist));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DisablePlugin));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DisablePowerUp));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.EmailCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.EnableEnterprisePluginWhitelist));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.EnablePlugin));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.EnablePowerUp));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MakeAdminOfBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MakeNormalMemberOfBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MakeNormalMemberOfOrganization));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MakeObserverOfBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MemberJoinedTrello));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MoveCardFromBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MoveCardToBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MoveListFromBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MoveListToBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveChecklistFromCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveFromEnterprisePluginWhitelist));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveFromOrganizationBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveMemberFromCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveOrganizationFromEnterprise));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UnconfirmedBoardInvitation));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UnconfirmedOrganizationInvitation));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateCheckItemStateOnCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateChecklist));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateList));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateMember));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateOrganization));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddLabelToCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CopyChecklist));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateBoardInvitation));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateBoardPreference));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateCheckItem));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateLabel));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.CreateOrganizationInvitation));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteAttachmentFromCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteCheckItem));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteComment));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteLabel));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MakeAdminOfOrganization));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveLabelFromCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveMemberFromBoard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.RemoveMemberFromOrganization));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateCheckItem));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateComment));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateLabel));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.VoteOnCard));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.AddCustomField));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.DeleteCustomField));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateCustomField));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.UpdateCustomFieldItem));
        receiver.BasicEvents.FireEvent(WebhookAction.CreateDummy(WebhookActionTypes.MoveCardToList));
