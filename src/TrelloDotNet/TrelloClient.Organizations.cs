...
namespace TrelloDotNet
{
    public partial class TrelloClient
    {
        ...
        public async Task<List<Organization>> GetOrganizationsForMemberAsync(string memberId, GetOrganizationOptions options, CancellationToken cancellationToken = default)
        {
            if (options == null)
            {
                return await GetOrganizationsForMemberAsync(memberId, cancellationToken);
            }
        ...
        {
            return await _apiRequestController.Get<TrelloPlanInformation>(GetUrlBuilder.GetOrganization(organizationId), cancellationToken, new QueryParameter(Constants.TrelloIds.QueryParameterNames.Fields, "id,name,premiumFeatures"));
        }
    }
}
